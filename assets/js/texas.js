...
var parkSevenEl = document.querySelector("#park-seven");
var parkEightEl = document.querySelector("#park-eight");
var parkNineEl = document.querySelector("#park-nine");
var parkTenEl = document.querySelector("#park-ten");
...
var displayParkButtons = function(npsData) {
    ...
    displayParkLinks(6, parkSevenEl);
    displayParkLinks(7, parkEightEl);
    displayParkLinks(8, parkNineEl);
    displayParkLinks(9, parkTenEl);
}
...
var getParkNames = function() {
    var apiUrl = "https://developer.nps.gov/api/v1/parks?stateCode=TX&stateCode=&limit=10&api_key=Hk3f7lw3henzsLy9mgZB5MvklVmdKkM87KKPROJy";
